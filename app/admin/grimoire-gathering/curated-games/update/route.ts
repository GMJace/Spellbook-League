...
import { updateCuratedGameRedirectPath } from "@/app/admin/grimoire-gathering/curated-game-mutations";
...
export async function POST(request: Request) {
  ...
  const redirectPath = await updateCuratedGameRedirectPath(formData);
